...
const ViewIndWorkout = () => {
    ...
    const fetchExerciseDetails = async () => {
      try {
        ...
        if (exerciseSnap.exists()) {
          ...
          const exerciseData = exerciseSnap.data();
          const exerciseArray = exerciseData.exercises || []; // Ensure it's always an array
  ...
  exercises.forEach((exercise) => {
    if (exercise.circuit_id && !seenCircuits.has(exercise.circuit_id)) {
      // Find all exercises in this circuit
      const circuitExercises = exercises.filter(
        (e) => e.circuit_id === exercise.circuit_id
      );
