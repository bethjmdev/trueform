...
//     // ✅ Remove undefined values from exercises before saving
//     const cleanExercises = selectedExercises.map((exercise) => {
//       return Object.fromEntries(
//         Object.entries(exercise).map(([key, value]) => [key, value ?? null]) // Convert undefined to null
//       );
//     });

//     const workoutExercises = {
//       exercises: cleanExercises, // 🔥 Save as an array
//     };
...
const CreateWorkout = () => {
  ...
  const handleAddExercise = () => {
    ...
    setNewExercise({
      ...
      tempo: "none", // ✅ Add missing field (default "none" to avoid undefined)
      tempoLength: "", // ✅ Add missing field
    });
  ...
  const handleSaveWorkout = async () => {
    ...
    const workoutExercises = selectedExercises.map((exercise) => ({
      ...
      tempoLength: exercise.tempoLength,
    }));
    ...
    try {
      ...
      await setDoc(doc(db, "CurrentWorkoutExercises", workoutId), {
